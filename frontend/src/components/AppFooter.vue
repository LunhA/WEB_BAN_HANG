  ...
  <div class="footer-container">
    ...
    <footer class="bg-dark text-center text-white">
      ...
      <div class="social-contact">
        <div class="facebook">
          <a class="social-icons" href=""
            ><img src="assets/images/icons/facebook.png" alt="facebook_icon"
          /></a>
        </div>
        <div class="twitter">
          <a class="social-icons" href=""
        ...
        <div class="instagram">
          <a class="social-icons" href=""
            ><img src="assets/images/icons/instagram.png" alt="instagram_icon"
          /></a>
        </div>
        <div class="youtube">
          <a class="social-icons" href=""
            ><img src="assets/images/icons/youtube.png" alt="youtube_icon"
          /></a>
        </div>
      </div>
      <div class="container p-4">
        ...
        <section class="mb-4">
          <p>
            Proud to be Ikus Audio. Born under the pressure of time, within 6
            short days, we have launched the largest system of selling
            headphones and audio equipment in Vietnam.
          </p>
        </section>
        <!-- Section: Text -->
